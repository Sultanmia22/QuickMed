    ...
    return (
        <div className=' flex flex-col justify-center '>
            ...
            <div className='my-10 md:w-1/3 w-full mx-auto'>
                <form onSubmit={handleSubmit(handleLogin)} className='flex flex-col justify-between gap-5'>
                    ...
                    <div>
                        <button className='btn bg-secondary text-white w-full hover:bg-primary duration-300' type="submit">Login</button>
                    </div>
                ...
                <div className='my-5'> <p>You Dont't have an account? <Link to={'/sign-up'} className='text-primary hover:text-secondary'>Registration Now</Link></p> </div>
            </div>
        </div>
    )
}
